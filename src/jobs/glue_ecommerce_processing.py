...
def run_spark_job(config: dict, spark=None) -> dict:
    ...
    metrics = MetricsEmitter.from_config(config, stage="glue_processing")
...
def main(argv=None) -> dict:
    ...
    input_prefix = lakehouse.dataset_prefix(config, "bronze/events")
    output_prefix = lakehouse.dataset_prefix(config, "silver/events")
